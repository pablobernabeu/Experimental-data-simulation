...
### **Parameters** to ensure reproducibility of the simulated data {style='max-height: 70px;'}
...
renderDT(
  datatable(final_dataset(), 
            ...
            options = list(order = list(0, 'asc'), dom = 'Bifrt', pageLength = nrow(final_dataset()), scroller = TRUE,
                           buttons = list(list(extend = 'csv', text = HTML('<i class="fas fa-download" aria-hidden="true"></i>&nbsp; Click to download (.csv)'),
