...
Column {style="margin-top:20px; max-width:700px"}
-----------------------------------------------------------------------
...
### **Summary including individual variables** ([larger summary](#summary))
...
### **General summary including dependent variables** ([larger summary](#summary))

```{r}

Dependent_tab_summary = 
  
  # If no continuous variables entered
  reactive({
    x = final_dataset() %>% 
...
Column {style="margin-top:20px; position:static; min-width: 580px; max-width: 580px; min-height: 1000px;"}
-----------------------------------------------------------------------
