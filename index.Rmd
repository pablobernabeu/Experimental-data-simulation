...
Since both of these variables use randomising, the user's parameters will be more closely approached with larger samples ([adjust](#size-n)). The overall summary, including the dependent variables, is shown below.
