...
### <span style='font-size:18px;'> &nbsp; &nbsp; &nbsp; &nbsp;  **Generate a pseudorandom data set to simulate an experiment.**</span>
...
<span style = 'font-size: 20px; color: #614064; padding-bottom: 5px;'><i class="fas fa-chalkboard-teacher"></i> &nbsp; <i class="fas fa-university"></i>

This web application is suitable for educational and research contexts in the experimental sciences. It allows the creation of varied data sets with specified characteristics, such as categorical or continuous, between-group or within-participant variables. Each of these characteristics can be selected along the different tabs. In the penultimate tab, a custom summary of the current data set can be constructed. In the last tab, the list of parameters and the data set can be downloaded.

Below, you can select the **number of decimals** to be kept in your continuous variables (if any).
...
renderUI({
  ...
  #     textAreaInput(height = '45px', resize = 'vertical', 'levels_Categorical_Independent1', NULL, value = 'A, B, C'),
  ...
  #   tagList(
  #     textAreaInput(height = '45px', resize = 'vertical', 'name_Categorical_Independent1', NULL, value = 'Cat_Indiv_2'),
  #     textAreaInput(height = '45px', resize = 'vertical', 'levels_Categorical_Independent1', NULL, value = 'A, B, C'),
  #     textAreaInput(height = '45px', resize = 'vertical', 'probability_Categorical_Independent1', NULL, value = '.3')
  #   )   
  # } else if(input$examples == 'Example 3') {
  #   tagList(
  #     textAreaInput(height = '45px', resize = 'vertical', 'name_Categorical_Independent1', NULL, value = 'Cat_Indiv_3'),
  #     textAreaInput(height = '45px', resize = 'vertical', 'levels_Categorical_Independent1', NULL, value = 'A, B, C'),
  #     textAreaInput(height = '45px', resize = 'vertical', 'probability_Categorical_Independent1', NULL, value = '.3')
  #   )   
  # }
...
reactive({
  if(isTruthy(input$probability_Categorical_Independent1)) {
    ...
    cat("\n\nNOTE: If any level has 0%, please slightly\nincrease sample size in the 'Size (N)' tab.")
  }
})
...
<div style = 'padding-left: 40px; padding-right: 40px; padding-top: 20px; padding-bottom: 20px; background-color: #FEFEFE; font-size: 16px; line-height: 1.6; max-width: 600px;'>
...
<div style = "padding-top: 5px; padding-right: 60px; padding-bottom: 100px; padding-left: 60px; background-color: #FEFEFE; font-size: 16px; line-height: 1.6;">

<h3 style='color:#2C6367'> Current sample size (*N*): `r reactive(final_N())` </h3>

Adjust *N* by changing the multiplication factor below. Note that large samples may incur some processing time.
...
Replace this column with names/categories (comma-separated). Delete to revert to numeric.
...
Column {style="position:static; min-width: 560px; max-width: 560px; min-height: 1000px;"}
-----------------------------------------------------------------------
