---
title: Simulation
author: '<a href="https://github.com/pablobernabeu/Experiment-simulation-app/" target="_blank"><button class="button-version">v `r app_version = 0.1; app_version # update version number here`</button></a> &nbsp; <a href = "#section-size-n"><button class="button-samplesize"><span style = "color: #FCFF89;">`r reactive(try(if(isTRUE(input$include_Participant_column)){paste0("N = ", final_N())}, silent = TRUE) %>% gsub("\\Error.*", "", .))`</span></button></a>'
output:
...
numericInput('rounding', 'Number of decimal places (rounding)', 3, min = 1)
...
Wickham, H., Averick, M., Bryan, J., Chang, W., McGowan, L. D. A., François, R., ... & Kuhn, M. (2019). Welcome to the Tidyverse. *Journal of Open Source Software, 4*(43), 1686. [https://doi.org/10.21105/joss.01686](https://doi.org/10.21105/joss.01686){target="_blank"}.
...
numericInput('multiply_N', NULL, 3, min = 1)
...
renderDT(
  datatable(custom_summary(), 
            ...
            options = list(order = list(1, 'asc'), dom = 'Bifrt', pageLength = nrow(custom_summary()), scroller = TRUE,
                           buttons = list(list(extend = 'csv', text = HTML('<i class="fas fa-download"></i>&nbsp; Download (.csv)'),
...
parameters = reactive({
  ...
  parameters = paste0('\n\nParameters for the reproducibility of the simulated data\n',
                      ...
                      '- Citation -\n',
                      'Bernabeu, P., & Lynott, D. (2020). Experiment simulation app\n',
                      '(Version ', app_version, ') [Web application].\n',
                      'https://github.com/pablobernabeu/Experiment-simulation-app/.\n',
                      '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n',
                      '- Home tab -\n',
