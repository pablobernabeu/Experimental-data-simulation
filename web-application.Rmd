...
A seed number is a code that allows the reproducibility of any data involving random generation. This applies to any variables created in the *Individuals* tab or in the *Dependent* tab. The number is shown below, where you can change it to any integer number up to Â±`r .Machine$integer.max`.
...
# Coding note: The seed from input$seed should now be set right before any random sampling function, 
# such as rnorm() or rbinom(), using set.seed(input$seed).
...
parameters = reactive({
  ...
  parameters = paste0('\n\nParameters for the reproducibility of the simulated data\n',
                      ...
                      'simulation of experimental data (Version ', app_version, ').\n',
                      'https://github.com/pablobernabeu/Experimental-data-simulation/.\n',
                      '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n',
                      '- Home tab -\n',
